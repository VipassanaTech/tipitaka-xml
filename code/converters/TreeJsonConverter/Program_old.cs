...
void TransliterateJSON(JToken token, Script script)
{
    if (token.Type == JTokenType.Object)
    {
        ...
        {
            string latinText = (string)obj["text"];
            latinText = latinText.ToLower();
            string otherText = ScriptConverter.Convert(latinText, Script.Latin, script);
            obj["text"] = otherText;
        }
